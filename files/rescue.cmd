...
## FIND rescue source if devnum undefined
    ...
    setenv DTB1     /rescue/fdt.kresq/amlogic/meson-gxl-s905x-khadas-vim.dtb
    setenv DTB2     /rescue/fdt.kresq/amlogic/meson-gxm-khadas-vim2.dtb
    setenv DTB3     /rescue/fdt.kresq/amlogic/meson-g12b-a311d-khadas-vim3.dtb
    setenv DTB31    /rescue/fdt.kresq/amlogic/meson-g12b-s922x-khadas-vim3.dtb
    setenv DTB3L    /rescue/fdt.kresq/amlogic/meson-sm1-khadas-vim3l.dtb
    setenv DTBE     /rescue/fdt.kresq/rockchip/rk3399-khadas-edge-v.dtb
...
test "$fdtfile" = "rockchip/rk3399-khadas-edge-v.dtb" && setenv Cdtb $DTBE && VENDOR_=rockchip
test "$fdtfile" = "rockchip/rk3399-khadas-edge-captain.dtb" && setenv Cdtb $DTBE && VENDOR_=rockchip
test "$fdtfile" = "rockchip/rk3399-khadas-edge.dtb" && setenv Cdtb $DTBE && VENDOR_=rockchip
